  ...
  def update(self, CC, CS, now_nanos):
    ...
    if (self.frame - self.last_button_frame) * DT_CTRL > 0.05:
      ...
      if CC.cruiseControl.cancel:
        ...
        can_sends.append(fiatcan.create_cruise_buttons2(self.packer, self.last_button_frame + 1, das_bus, activate=False))

      # ACC resume from standstill
      elif CC.cruiseControl.resume:
        self.last_button_frame = self.frame
        can_sends.append(fiatcan.create_cruise_buttons2(self.packer, self.last_button_frame + 1, das_bus, activate=True))
